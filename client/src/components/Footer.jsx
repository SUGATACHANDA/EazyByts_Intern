const Footer = () => {
    return (
        <footer className="border-t border-gray-700 px-8 py-8">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <div className="flex items-center space-x-4">
                    <span className="font-bold">Sugata</span>
                    <span className="text-gray-400">scbabai2704@gmail.com</span>
                </div>
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div className="flex space-x-3">
                        <a href="https://github.com/SUGATACHANDA" target="_blank" className="text-gray-400 hover:text-white transition-colors">
